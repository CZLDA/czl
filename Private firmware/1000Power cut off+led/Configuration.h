...
#define STRING_CONFIG_H_AUTHOR "(CR-5)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "www.DC3D.com"
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 1005
#define Y_MAX_POS 1005
#define Z_MAX_POS 1225
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define RIGHT_PROBE_BED_POSITION 900
    #define FRONT_PROBE_BED_POSITION 100
    #define BACK_PROBE_BED_POSITION 900
...
s
#define DEFAULT_AXIS_STEPS_PER_UNIT   {66.65,66.68,1280.00,118.95}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {300, 300, 100, 5000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
