...
extern struct power_off_info_t power_off_info;     //外部结构关闭电源关闭信息；
extern int power_off_commands_count;               //外部电源关闭命令计数；
extern int power_off_type_yes;                   //外部关闭电源类型为“是”；
#endif    //
...
#define IS_SD_PRINTING (card.sdprinting)
  ...
  #endif
#else
  //No card detect line? Assume the card is inserted.  没有卡检测线？假设卡插入。
